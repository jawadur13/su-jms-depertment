...
export const metadata = {
  title: 'News — Department of Architecture',
  description:
    'Latest news from the Department of Architecture, Sonargaon University — events, workshops, industrial visits, and academic milestones.',
};
