...
export const metadata = {
  title: 'Faculty Members — Department of Architecture',
  description:
    'Faculty members of the Department of Architecture, Sonargaon University — Dean, Head of Department, full-time and part-time faculty.',
};
