...
export const metadata = {
  ...
  description:
    'Privacy Policy for the Department of Journalism and Media Studies, Sonargaon University — how we handle visitor information and respect your consent.',
};
...
export default async function PrivacyPolicyPage() {
  ...
  if (!row) {
    throw new Error(
      'LegalPagesContent row missing (id="singleton"). Restore the required CMS data.',
    );
  }
