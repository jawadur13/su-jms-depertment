...
export default function JoinInnovationHubButton({ label }: { label: string }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setPending(true);
    try {
      const res = await fetch('/api/innovation-hub/apply', {
        method: 'POST',
    ...
    <>
      ...
      {open && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="innovation-hub-join-title"
        ...
        >
          ...
          <div className="relative w-full max-w-2xl bg-white text-gray-800 rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white border-b border-gray-100 px-7 md:px-8 py-5 flex items-start justify-between gap-3 z-[1]">
              <div>
                <h2
                  id="innovation-hub-join-title"
                  className="text-xl md:text-2xl font-display font-bold text-primary leading-tight"
                >
                  Join SU Innovation Hub
                </h2>
                <p className="text-sm text-gray-500 mt-1">
                  Fill in your details — the Innovation Hub team will reach out shortly.
                </p>
              </div>
              <button
                type="button"
            ...
            {submitted ? (
              <div className="px-7 md:px-8 py-12 text-center">
                ...
                <p className="text-sm text-gray-600 max-w-sm mx-auto">
                  We&apos;ve received your submission. The Innovation Hub team will get in
              ...
              <form onSubmit={handleSubmit} className="px-7 md:px-8 py-6 space-y-5" noValidate>
                ...
                <Field label="Why do you want to join?" required>
                  <textarea
                    ...
                    placeholder="A short paragraph on what excites you about the Innovation Hub — projects, interests, what you'd like to contribute."
                ...
                >
                  <label htmlFor="innovation-hub-website">Website</label>
                  <input
                    id="innovation-hub-website"
                    type="text"
                    name={HONEYPOT_NAME}
                    tabIndex={-1}
                    autoComplete="off"
